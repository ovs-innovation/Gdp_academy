               ...
               <div className="col-xl-5 col-lg-6">
                  <div className="banner__content">
                     <h3 className="title tg-svg" data-aos="fade-right" data-aos-delay="400">
                        {t('common.banner_title_prefix')}
                        <span className="position-relative" style={{ marginLeft: "10px", display: "inline-block" }}>
                           ...
                           {t('common.banner_title_highlight')}
                        </span>
                     </h3>
                     <p data-aos="fade-right" data-aos-delay="600">
                        {t('common.banner_description')}
                     </p>
                     <div className="banner__btn-wrap" data-aos="fade-right" data-aos-delay="800">
                        <Link to="/courses" className="btn arrow-btn">
                           {t('common.start_free_trial')} <BtnArrow />
                        </Link>
                     </div>
                  </div>
               </div>
                  ...
                  <div className="banner__images">
                     ...
                     <div className="banner__author">
                        <div className="banner__author-item">
                           <h6 className="name" style={{ fontSize: '18px', fontWeight: 'bold' }}>
                              {t('common.banner_features')}
                           </h6>
                        </div>
