                  ...
                  <div className="col-lg-6 col-md-9">
                     <div className="about__images">
                        ...
                        <div className="about__enrolled" data-aos="fade-right" data-aos-delay="200">
                           <p className="title"><span>37K+</span> {t('common.enrolled_students')}</p>
                  ...
                  <div className="col-lg-6">
                     <div className="about__content">
                        <div className="section__title">
                           <span className="sub-title">{t('common.about_subtitle')}</span>
                           <h2 className="title">
                              {t('common.about_title_1')}
                              <span className="position-relative title-shape-wrap">
                                 ...
                                 {t('common.about_title_highlight')}
                              </span>
                              , {t('common.about_title_2')}
                           </h2>
                        </div>
                        <p className="desc">{t('common.about_description')}</p>
                        <ul className="about__info-list list-wrap">
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">{t('common.about_list_1')}</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">{t('common.about_list_2')}</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">{t('common.about_list_3')}</p>
                           </li>
                        </ul>
