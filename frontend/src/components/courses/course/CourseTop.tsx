...
const CourseTop = ({ startOffset, endOffset, totalItems, programs, setPrograms, handleTabClick, activeTab }: ProgramTopProps) => {
   ...
   const selectHandler = (event: ChangeEvent<HTMLSelectElement>) => {
      ...
      switch (select) {
         case 'popular':
            ...
            break;
         case 'price':
            // Price sorting not implemented for programs list; keep current order
            break;
         case 'rating':
            // Rating sorting not implemented for programs list; keep current order
            break;
         default:
