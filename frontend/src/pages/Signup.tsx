        ...
        <div className="container">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <p className="terms-text" style={{ fontSize: '11px', color: 'var(--text-gray)', marginBottom: '32px', letterSpacing: '1px' }}>
            ...
            <div className="auth-footer">
              <p>Already a member? <Link to="/login" className="gradient-text">LOGIN TO YOUR PORTAL</Link></p>
            </div>
          </motion.div>
        </div>
      </section>
