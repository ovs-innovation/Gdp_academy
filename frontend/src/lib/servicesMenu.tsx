...
export const SERVICES_MEGA_MENU: ServicesMenuGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/services/thyroid-wellness",
      ...
      },
      {
        ...
        href: "/services/post-pregnancy-wellness",
...
export const EXPLORE_PROGRAMS: {
...
}[] = [
  {
    ...
    href: "/services/wedding-choreography",
  ...
  },
  {
    ...
    href: "/services/online-dance-classes",
  ...
  },
  {
    ...
    href: "/services/pre-recorded-courses",
